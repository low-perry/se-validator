...
## Inputs Reviewed
- /Users/lowperry/projects/se-validator/fixtures/catalog/good-feed.xml
- /Users/lowperry/projects/se-validator/fixtures/catalog/good-feed-cat.xml
...
Root: items
Records: 12
Object counts: product=12
Required coverage: identity 12/12 (100%), title 12/12 (100%), web_url 12/12 (100%)
Common fields: availability 12/12, availability_rank 12/12, brand 12/12, category 12/12, identity 12/12, image_link_l 12/12, price_eur 12/12, title 12/12, web_url 12/12, color 10/12, item_group_id 10/12, size 10/12
Category model:
...
Examples:
- product SKU-1: Blue Shirt (2 category path(s), item_group_id=SHIRT-1)
- product SKU-2: Red Shirt (2 category path(s), item_group_id=SHIRT-1)
- product SKU-3: Black Hoodie (2 category path(s), item_group_id=HOODIE-1)
- product SKU-4: Gray Hoodie (1 category path(s), item_group_id=HOODIE-1)
- product SKU-5: Summer Dress (2 category path(s), item_group_id=DRESS-1)
...
Root: categories
Records: 16
Object counts: category=16
Required coverage: identity 16/16 (100%), title 16/16 (100%), web_url 16/16 (100%)
Common fields: identity 16/16, title 16/16, web_url 16/16, hierarchy 12/16
Category model:
- 16 independently indexed categories; 12 include hierarchy.
Content Update model:
- Not a Content Update payload.
Variant model:
- No variant grouping or nested variant evidence found.
Pairing model:
- No category_id pairing evidence found.
Examples:
- category cat-apparel: Apparel
- category cat-men: Men
- category cat-men-tshirts: T-shirts
- category cat-men-hoodies: Hoodies
...
Inferred structures:
fixtures/catalog/good-feed.xml: feed-xml/product-feed, records=12
fixtures/catalog/good-feed-cat.xml: feed-xml/category-feed, records=16
