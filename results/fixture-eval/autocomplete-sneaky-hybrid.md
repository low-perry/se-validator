...
Generated: 2026-04-17T00:57:30.439Z
...
- fixtures/frontend/autocomplete-sneaky-hybrid.html: html / datalayer (90%)

## Detected Capabilities
- fixtures/frontend/autocomplete-sneaky-hybrid.html: endpoints=autocomplete, top_items, trending_queries; analytics=Autocomplete view, Recommendation view, click/select, no-results
...
State: failed
Area: frontend
Evidence: fixtures/frontend/autocomplete-sneaky-hybrid.html
Problem: fixtures/frontend/autocomplete-sneaky-hybrid.html does not show q in the autocomplete request.
Recommended fix: Send the current search input value as q for query autocomplete.
Likely code: fixtures/frontend/autocomplete-sneaky-hybrid.html:46
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-sneaky-hybrid.html
Problem: fixtures/frontend/autocomplete-sneaky-hybrid.html does not show analytics items using hit.url as item_id/url.
...
Likely code: fixtures/frontend/autocomplete-sneaky-hybrid.html:127
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-sneaky-hybrid.html
Problem: fixtures/frontend/autocomplete-sneaky-hybrid.html calls Trending Queries but does not show response titles being read.
Recommended fix: Map the Trending Queries API response with item.title before rendering placeholders or query suggestions.
Likely code: fixtures/frontend/autocomplete-sneaky-hybrid.html:99
Snippet: `items: hits.map((hit, index) => ({`
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-sneaky-hybrid.html
Problem: fixtures/frontend/autocomplete-sneaky-hybrid.html calls Top Items but does not show a focus listener on the search input.
Recommended fix: Fetch top items when the search box receives focus and the input is empty.
Likely code: fixtures/frontend/autocomplete-sneaky-hybrid.html:62
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-sneaky-hybrid.html
Problem: fixtures/frontend/autocomplete-sneaky-hybrid.html calls Trending Queries but does not show placeholder usage or Search Results tracking after a click.
...
Likely code: fixtures/frontend/autocomplete-sneaky-hybrid.html:8
Snippet: `- Trending queries fetched but never mapped to anything visible.`
