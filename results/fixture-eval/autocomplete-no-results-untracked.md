...
Generated: 2026-04-17T00:57:29.506Z
...
## Inputs Reviewed
- /Users/lowperry/projects/se-validator/fixtures/frontend/autocomplete-no-results-untracked.html

## Detected Integration Shape
- fixtures/frontend/autocomplete-no-results-untracked.html: html / datalayer (90%)

## Detected Capabilities
- fixtures/frontend/autocomplete-no-results-untracked.html: endpoints=autocomplete; analytics=Autocomplete view, click/select
...
State: failed
Area: frontend
Evidence: fixtures/frontend/autocomplete-no-results-untracked.html
Problem: fixtures/frontend/autocomplete-no-results-untracked.html handles empty hits but does not show an Autocomplete view with an empty items array.
Recommended fix: When hits is empty, still send the Autocomplete view event with items: [].
Likely code: fixtures/frontend/autocomplete-no-results-untracked.html:37
Snippet: `if (!hits || hits.length === 0) {`
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-no-results-untracked.html
Problem: fixtures/frontend/autocomplete-no-results-untracked.html does not reference https://live.luigisbox.com/v1/top_items.
...
Area: frontend
Evidence: fixtures/frontend/autocomplete-no-results-untracked.html
Problem: fixtures/frontend/autocomplete-no-results-untracked.html does not reference https://live.luigisbox.com/v2/trending_queries.
...
Profile: service=autocomplete; analyticsMode=any; autocomplete=required; topItems=optional; trendingQueries=optional
Docs root: /Users/lowperry/projects/se-validator/docs
Files to inspect: /Users/lowperry/projects/se-validator/fixtures/frontend/autocomplete-no-results-untracked.html
